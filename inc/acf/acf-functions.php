...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			'key' => 'field_5bd6a3c454bb9',
			'label' => 'Fonts Settings Content',
...
<?php
	...
	//bootstrap carousel
	$interval = get_option( 'auto_delay' );
	$pause = get_option( 'auto_hover' );
?>
