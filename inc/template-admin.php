...
function qqlanding_custom_settings(){
	register_setting( 'match-settings-group-a', 'match_logo_a', 'qqlanding_vid_sanitize_text' );
	register_setting( 'match-settings-group-a', 'match_title_a', 'qqlanding_vid_sanitize_text' );
	register_setting( 'match-settings-group-a', 'match_date_a' );
	...
	add_settings_section( 'qqlanding-match-options', 'Match A', 'qqlanding_match_a_options', 'vm_settings' );
	//add_settings_section( 'qqlanding-match-b-options', 'Match B', 'qqlanding_match_b_options', 'vm_settings' );
	...
	add_settings_field( 'match-title-b', 'Title B', 'qqlanding_video_title_b', 'vm_settings', 'qqlanding-match-b-options' );
	add_settings_field( 'match-date-b', 'Date B', 'qqlanding_video_date_b', 'vm_settings', 'qqlanding-match-b-options' );
