...
<?php
	...
	<?php else: ?>
	<div class="vm-sidebar vm-wrapper-a item-no-avail">
		<div class="prev-details-wrap">
			<h2>No Match Available</h2>
		</div>
	</div>
	<?php endif; /*-End-Group-A--**/
	...
	<div class="vm-sidebar vm-wrapper-b">
		<?php while( $query_match_b->have_posts() ) : $query_match_b->the_post();
	...
	<?php else: ?>
	<div class="vm-sidebar vm-wrapper-b item-no-avail">
		<div class="prev-details-wrap">
			<h2>No Match Available</h2>
		</div>
	</div>
<?php endif; /*-End-Group-B--**/ 
	...
	if ( $query_match_c->have_posts() ) : ?>
		<div class="vm-sidebar vm-wrapper-c">
			<?php while( $query_match_c->have_posts() ) : $query_match_c->the_post();
	...
	<?php else: ?>
		<div class="vm-sidebar vm-wrapper-c item-no-avail">
			<div class="prev-details-wrap">
				<h2>No Match Available</h2>
			</div>
		</div>
<?php endif; /*-End-Group-C--**/ ?>
