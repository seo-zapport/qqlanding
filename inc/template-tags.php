...
if ( ! function_exists( 'qqlanding_posted_on' ) ) :
	...
	function qqlanding_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'qqlanding' ),
...
if ( ! function_exists( 'qqlanding_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function qqlanding_posted_by() {
		$url = get_author_posts_url( get_the_author_meta( 'ID' ) );
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'qqlanding' ),
			'<span class="author vcard"><a class="url fn n" href="' . esc_url( $url ) . '">' . esc_html( get_the_author() ) . '</a></span>'
		);
...
if ( ! function_exists( 'qqlanding_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function qqlanding_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'qqlanding' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'qqlanding_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function qqlanding_post_thumbnail() {
