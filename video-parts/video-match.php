			...
			<div class="row">
				<?php
					...
					if ( $query_match_a->have_posts() ) {
						...
						?>
							<div class="col-12 col-md-12 col-lg-4 <?php echo $class_col; ?> px-2">
					...
					if ( $query_match_b->have_posts() ) {
						while ( $query_match_b->have_posts() ) : $query_match_b->the_post();
							...
							<div class="col-12 col-md-12 col-lg-4  <?php echo $class_col_b; ?> px-2">
					...
					if ( $query_match_c->have_posts() ) {
						while( $query_match_c->have_posts() ) : $query_match_c->the_post();
							...
							<div class="col-12 col-md-12 col-lg-4  <?php echo $class_col_c; ?> px-2">
